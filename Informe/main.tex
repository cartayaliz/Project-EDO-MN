...
\tutors{
Prof. Tutor de Ecuaciones Diferenciales \\
Prof. Tutor de Matemática Numérica}
...
\includegraphics[width=0.5\textwidth]{convergencia.png}
...
La ley de Torricelli establece que la razón de cambio respecto del tiempo de un volumen V de agua en un tanque de drenado es proporcional a la raíz cuadrada de la profundidad y del agua en el tanque: dV/dt =−k√y donde k es una constante, $k =a \sqrt{2g}$

...
Si $A(y)$ es constante (tanque cilíndrico), $m$ es proporcional a $\sqrt{y}$. Así que, a mayor $y$, la pendiente es más negativa, es decir, más inclinada hacia abajo.

Si $A(y)$ crece con $y$ (tanque que se ensancha hacia arriba), el factor $1/A(y)$ reduce la magnitud de la pendiente para $y$ grandes, haciendo las pendientes menos inclinadas en la parte inferior y más inclinadas en la superior.

Si $A(y)$ decrece con $y$ (tanque que se estrecha hacia arriba), la magnitud de la pendiente aumenta para $y$ grandes, haciéndolas más inclinadas en la parte inferior y menos inclinadas en la superior.
